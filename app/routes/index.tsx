...
import thumbnailNumberKifuInput from "../number-kifu-input/thumbnail.png";
...
export default function Index() {
    return (
        <div className={"mx-2"}>
            ...
            将棋好きのためのツール集です（予定）
            <ul className="grid gap-5 auto-rows-fr my-4 justify-center md:justify-start"
            ...
            <ul className="grid gap-5 auto-rows-fr my-4 justify-center md:justify-start"
                style={{gridTemplateColumns: "repeat(auto-fit, 240px)"}}>
                <CardLink to="/number-kifu-input" className="opacity-70">
                    <img src={thumbnailNumberKifuInput}/>
                    <div className="px-4 py-2"> 数字棋譜入力</div>
                </CardLink>
            </ul>
            <H1>作者</H1>
